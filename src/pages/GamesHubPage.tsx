...
const games = [
  ...
  { icon: Wallet, title: "Budget Challenge", desc: "Given a monthly salary and random life events — make smart decisions to survive and grow savings.", difficulty: "Easy", xp: "80-150", time: "10-15 min", players: 892, link: "/games/budget-challenge" },
  ...
  { icon: PieChart, title: "Portfolio Builder", desc: "Allocate across equity, debt, gold, and real estate. Simulate 10-year returns.", difficulty: "Hard", xp: "150-250", time: "20-25 min", players: 567, link: "/games/portfolio-builder" },
